        ...
        <View style={styles.container}>
            <ScrollView>
                <View style={styles.infoText}>
                    ...
                    <Text style={styles.h1}>Ünsüz Harflerin Kuralları</Text>
                    ...
                    <View style={styles.p5}>
                        <Text>sadece "I" dan önce veya sonra, "ık" veya "kı" sesleri vermesi için kullanılır.(𐰶)</Text>
                        <Text>sadece "O" ve "U" dan önce veya sonra, "ok/uk" veya "ko/ku" sesleri vermesi için kullanılır.(𐰸)</Text>
                        <Text>sadece "Ö" ve "Ü" dan önce veya sonra, "ök/ük" veya "kö/kü" sesleri vermesi için kullanılır.(𐰰)</Text>
                    </View>
